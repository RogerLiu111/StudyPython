...
- proxy(代理)
            ...
            rsp = requests.request("get", "http:xxxxxx", proies=proxies)
...
- 用户验证
    - 代理验证
            ...
            # 可能需要使用HTTP basic Ausic，可以这样
            # 格式为        用户名 :密码  @ 代理地址   :端口地址
            proxy = {"http":"china:123456@192.168.1.23:4444"}
...
- session
    ...
    - 能让我们夸请求时保持某些参数，比如同一个session实例发出的所有请求之间保持cookie
